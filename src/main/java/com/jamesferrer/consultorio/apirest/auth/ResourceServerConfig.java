...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter{
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers(HttpMethod.GET, "/api/empleados", "/api/empleados/page/**", 
				"/api/uploads/img/**", "/images/**").permitAll()
		.antMatchers(HttpMethod.GET, "/api/perfiles").permitAll()
		.antMatchers(HttpMethod.GET, "/api/pacientes").permitAll()
		.antMatchers(HttpMethod.GET, "/api/citas").permitAll()
